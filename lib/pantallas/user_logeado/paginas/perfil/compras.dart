...
class ComprasPage extends StatefulWidget {
  final String inicio;
  const ComprasPage(this.inicio, {super.key});

  @override
  ComprasPageApp createState() => ComprasPageApp();
}
...
class ComprasPageApp extends State<ComprasPage> {
  @override
  void initState() {
    super.initState();
...
// Mostrar informacion del usuario en pantalla
  ...
  Future<void> crearCompraApi(
      String nombreEvento,
      String token,
      Map<String, dynamic> datosUsuario,
      List<Map<String, dynamic>> listaProductos) async {
